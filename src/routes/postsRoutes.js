...
app.post("/upload", upload.single("imagem"), uploadImagem), async (req, res) => {
    console.log(req.file); // Adicione esta linha para verificar o objeto req.file

    // ... (resto do seu código)
};
    //função controladora para processamento da imagem
